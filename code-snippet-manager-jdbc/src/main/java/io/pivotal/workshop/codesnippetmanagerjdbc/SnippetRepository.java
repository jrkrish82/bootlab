...
public class SnippetRepository {
    ...
    private final String SQL_INSERT = "insert into testdb.snippet (id, title, code, created, modified)" +
            " values(?, ?, ?, now(), now())";
    ...
    private final String SQL_QUERY_ALL = "select * from testdb.snippet";
    ...
    private final String SQL_QUERY_BY_ID = "select * from testdb.snippet where id = ?";
